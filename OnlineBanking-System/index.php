...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <a href="index.php" class="logo"><img src="assets/img/lg-1328.png" alt="" class="img-fluid"> &nbsp O B S</a>
      <!-- <h1 class="logo"><a href="index.html">WestView Bank</a></h1> -->
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        ...
        <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <img src="assets/img/frontbnk.png" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            ...
            <p class="font-italic">
              You just need to follow 4 steps to start banking with us. Lets introduce you with the account creation steps.
            </p>
			<!-- Log on to codeastro.com for more projects -->
            <ul>
              <li><i class="bi bi-check-circle"></i> Fill Your Basic Details.</li>
              <li><i class="bi bi-check-circle"></i> Upload Your KYC Documents.</li>
              <li><i class="bi bi-check-circle"></i> Validate Your Document and Contact Number.</li>
              <li><i class="bi bi-check-circle"></i> Set Up Username and Password.</li>
            </ul>
          ...
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  O B S is the best bank for Monitoring account it provide data in graphical manner from that can we understand our account is in profit or loss. Also i use saving option which is wonderful.
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/140x140.png" class="testimonial-img" alt="">
                <h3>William T. Truax</h3>
                <h4>Customer</h4>
              </div>
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                  The Transaction system of the O B S is very fast. We can easily manage our transaction history
                  with digramatical manner
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/140x140.png" class="testimonial-img" alt="">
                <h3>Carlos M. Collins</h3>
                <h4>Customer</h4>
              </div>
            </div><!-- End testimonial item -->
            ...
            <div class="swiper-slide">
              <div class="testimonial-item">
                <p>
                  ...
                  and start your online banking. Thank You O B S!
                  <i class="bx bxs-quote-alt-right quote-icon-right"></i>
                </p>
                <img src="assets/img/testimonials/140x140.png" class="testimonial-img" alt="">
                <h3>Robert J. Reyes</h3>
                <h4>Customer</h4>
              </div>
            </div><!-- End testimonial item -->
    ...
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6">
            <div class="info-box mb-4">
              <i class="bx bx-map"></i>
              <h3>Our Address</h3>
              <p>Bank Of Karad <br>Saidapur, Karad</p>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 ">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d62018.24214950488!2d74.15544289928899!3d17.288971760283246!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc182450c753bad%3A0xb3493b19ae7886ca!2sKarad%2C%20Maharashtra!5e0!3m2!1sen!2sin!4v1745659024315!5m2!1sen!2sin" width="500" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              Saidapur<br>
              Maharastra <br><br>
              <strong>Phone:</strong> +91 88776 55455<br>
              <strong>Email:</strong> info@onlinebanking.info<br>
            </p>
          </div>
          ...
          <div class="col-lg-4 col-md-6 footer-newsletter">
            <div class="d-flex justify-content-center">
              <img src="assets/img/lg-1328.png" style="width: 100px; height: 100px;" alt="">
            </div>

            <h1 class="text-center mt-2">O B S</h1>
          </div>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; <strong><span>Online Banking System</span></strong> - Developed by Guruprasad Patil
          </div>
          <div class="credits">
