            ...
            <div class="col-sm-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-center">
                            <button type="button" id="EditProfileBtn" class="btn btn-primary mb-2" data-toggle="modal" data-target="#EditProfileModal"><i class="fas fa-user-edit"></i> Edit Profile</button>
                        </div>
